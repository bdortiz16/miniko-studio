...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      <span className="relative grid h-16 w-16 place-items-center overflow-hidden rounded-full border-2 border-[#25D366] bg-white shadow-lg transition hover:scale-105">
        {icon ? (
          /* eslint-disable-next-line @next/next/no-img-element */
          <img src={icon} alt="Soporte" className="h-full w-full object-contain p-1" />
        ) : (
