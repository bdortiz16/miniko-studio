...
import { MiGrid, MiBox, MiPeople, MiChart, MiTag, MiTicket, MiMail, MiGear, MiUser, MiBag, MiPaw } from "@/components/MiniIcons";
...
const NAV = [
  ...
  { href: "/panel-mk9z3/mascotas", label: "Mascotas NFC", Icon: MiPaw },
