...
const COMMON_PROMPT =
  ...
  "Do NOT add, remove or change facial hair: keep EXACTLY the same beard, mustache or stubble as in the photo (if the person is clean-shaven or only has light stubble, keep it that way — do NOT add a mustache or thick beard that is not there). Do not change their age. " +
